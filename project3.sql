...
INSERT INTO employees (first_name, last_name, address, email, date_of_birth, phone, start_date, title) VALUES
...
INSERT INTO customers (name, address, email, date_of_birth, phone) VALUES
...
INSERT INTO lawns (address, size, date_added, notes) VALUES
('100 N College Ave Bloomington, IN', 12500, '2023-04-22', 'Downtown lot without much parking. No mowing during the week!'),
('50 Elm St Bloomington, IN', 8000, '2023-05-10', 'Front yard only.'),
('789 Oak Ave Bloomington, IN', 6000, '2023-06-15', 'Backyard with a garden.'),
('654 Pine St Bloomington, IN', 10000, '2023-07-01', 'Large front and side lawn.'),
('222 Elm Rd Bloomington, IN', 3500, '2023-08-05', 'Small corner lot with minimal maintenance needed.');
